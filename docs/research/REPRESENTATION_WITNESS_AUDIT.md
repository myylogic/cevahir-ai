# Temsil değişimi hipotezi: ilk yanlışlama deneyi

20 Eylül 2026. [Bağımsız keşif kaydındaki](FRONTIER_DISCOVERY_2026_09_20.md) H4'ün devamıdır. Önceki araştırma uygulamalarına dokunulmadı; bu çalışma ana çalışma akışından bağımsızdır.
