# Cevahir — Ortak bir yaşamda öğrenme ve hazır kimliklerin kaldırılması
...
[Denklemler, erişim hakları, bütün karşılaştırmalar ve negatifler](JOINT_STREAM.md).
...
[Tam sonuçlar, ayrıcalıklı karşılaştırmalar ve karşı örnekler](TEMPORAL_RELATION.md).
...
[İspatlar, karşı örnekler ve literatür denetimi](PRINCIPLE_AUDIT.md).
