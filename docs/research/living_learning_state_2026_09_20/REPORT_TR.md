# Cevahir — Deneyim, hangi geçmiş ayrımlarının taşınacağını değiştirebilir
...
Önceki [ilk tur](../living_learning_2026_09_20/REPORT_TR.md), [kapsam değerlendirmesi](../living_learning_reassessment_2026_09_20/REPORT_TR.md), [ortak yaşam](../living_learning_joint_2026_09_20/REPORT_TR.md) ve [öğrenilmiş güncelleme](../living_learning_update_2026_09_20/REPORT_TR.md) korunur. Yeni tur başında **74 eski dosyanın** içerik özeti alındı. Negatifler ve literatür eşleşmeleri geri alınmadı. Ana sisteme entegrasyon ve GitHub'a push yapılmadı.
...
[Tam karşı örnekler, yapıcı koşullar ve kaynaklar](FAILURE_IDENTIFIABILITY.md).
...
[Bütün yöntemler, skorlar, sayaçlar ve deney ayrıntıları](EXPERIMENT.md).
